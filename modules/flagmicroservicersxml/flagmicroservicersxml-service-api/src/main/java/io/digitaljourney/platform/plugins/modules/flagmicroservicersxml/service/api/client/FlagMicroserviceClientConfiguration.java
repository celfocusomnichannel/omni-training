...
@ObjectClassDefinition(name = "%name", description = "%description", localization = "OSGI-INF/l10n/client", icon = @Icon(resource = "OSGI-INF/icon/instance.png", size = 32))
public @interface FlagMicroserviceClientConfiguration {
	/** ElasticSearch DAO Component Persistent Identifier */
	public static final String CPID = "io.digitaljourney.platform.plugins.modules.flagmicroservicersxml.service.api.client"; 
	...
	String name() default "scheduler-client"; 
	 ...
	 */
	@AttributeDefinition(name = "%proxyType.name", description = "%proxyType.description", options = { @Option(label = "HTTP", value = "HTTP"),
