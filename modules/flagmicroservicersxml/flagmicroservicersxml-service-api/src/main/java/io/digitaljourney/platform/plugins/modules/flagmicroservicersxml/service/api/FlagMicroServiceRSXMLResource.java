package io.digitaljourney.platform.plugins.modules.flagmicroservicersxml.service.api;
...
@Api(value = "Flag SOAP Microservice Description", authorizations = { @Authorization(value = RSProperties.SWAGGER_BASIC_AUTH),
...
public interface FlagMicroServiceRSXMLResource {

	@GET
    @Path("/{alphaCode}")
    @ApiOperation(value = "Get flag", response = FlagDTO.class)
    FlagDTO getFlag(@ApiParam(value = "alphaCode", required = true) @PathParam("alphaCode") String isoCode);
