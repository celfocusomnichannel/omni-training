...
public @interface ProductServiceClientConfiguration {
	/** Component Persistent Identifier */
	public static final String CPID = "io.digitaljourney.platform.plugins.modules.productservice.service.api.client";
	...
	String name() default "productservice-client";
