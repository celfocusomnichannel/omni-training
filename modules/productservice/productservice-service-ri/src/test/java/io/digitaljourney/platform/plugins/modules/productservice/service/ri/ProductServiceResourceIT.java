...
import io.digitaljourney.platform.plugins.modules.productservice.service.ri.ProductServiceResourceConfig;
...
public class ProductServiceResourceIT extends BaseTestSupport {
	...
	protected Option bundles() {
		return composite(super.bundles(), rsProviderWithRSClient(),
				...
				testBundle("io.digitaljourney.platform.plugins.modules", "productservice-service-ri"));
	}
	...
	public void testBundle() {
		assertBundleActive("io.digitaljourney.platform.plugins.modules.productservice-service-ri");
	}
