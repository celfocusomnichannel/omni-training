package io.digitaljourney.platform.plugins.modules.modules.productmanagement.data.ri.db.sample;
...
import io.digitaljourney.platform.plugins.modules.modules.productmanagement.data.ri.rdb.sample.SampleDAOConfig;
import io.digitaljourney.platform.plugins.modules.modules.productmanagement.entity.Sample;
import io.digitaljourney.platform.plugins.modules.modules.productmanagement.entity.SampleBuilder;
...
public class SampleDAOIT extends BaseTestSupport {
  ...
  protected Option bundles() {
    return composite(super.bundles(), jpaClient(),
        mavenBundles("io.digitaljourney.platform.plugins.modules.modules", "productmanagement-entity"),
        testBundle("io.digitaljourney.platform.plugins.modules.modules", "productmanagement-data-ri"));
  }
  ...
  public void testBundle() {
    assertBundleActive("io.digitaljourney.platform.plugins.modules.modules.productmanagement-data-ri");
  }
