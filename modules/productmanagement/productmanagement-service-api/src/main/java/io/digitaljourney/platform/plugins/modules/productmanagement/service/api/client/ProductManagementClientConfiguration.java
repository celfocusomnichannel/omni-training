...
public @interface ProductManagementClientConfiguration {
	
	/** Component Persistent Identifier */
	public static final String CPID = "io.digitaljourney.platform.plugins.modules.productmanagement.service.api.client";
	...
	String name() default "productmanagement-client";
