...
import io.digitaljourney.platform.plugins.modules.modules.productmanagement.service.api.ProductManagementResource;
import io.digitaljourney.platform.plugins.modules.modules.productmanagement.service.api.dto.SampleDTO;
import io.digitaljourney.platform.plugins.modules.modules.productmanagement.service.api.dto.SampleDTOBuilder;
...
public class ProductManagementResourceIT extends BaseTestSupport{
	...
	protected Option bundles() {
		return composite(super.bundles(), rsProviderWithJPAClient(),
				...
				testBundle("io.digitaljourney.platform.plugins.modules.modules", "productmanagement-service-ri"));
	}
	...
	public void testBundle() {
		assertBundleActive("io.digitaljourney.platform.plugins.modules.modules.productmanagement-service-ri");
	}
