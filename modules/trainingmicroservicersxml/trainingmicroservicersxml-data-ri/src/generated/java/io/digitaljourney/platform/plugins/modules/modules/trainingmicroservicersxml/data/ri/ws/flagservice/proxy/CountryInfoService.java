 ...
 * 2021-08-30T12:46:13.646+01:00
 * Generated source version: 3.2.14
 *
 */
@WebServiceClient(name = "CountryInfoService",
                  wsdlLocation = "file:/D:/wizzio/dev/repos/omni-training/modules/trainingmicroservicersxml/trainingmicroservicersxml-data-ri/src/main/resources/wsdl/flagservice.xml",
...
public class CountryInfoService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/wizzio/dev/repos/omni-training/modules/trainingmicroservicersxml/trainingmicroservicersxml-data-ri/src/main/resources/wsdl/flagservice.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CountryInfoService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/wizzio/dev/repos/omni-training/modules/trainingmicroservicersxml/trainingmicroservicersxml-data-ri/src/main/resources/wsdl/flagservice.xml");
        }
        WSDL_LOCATION = url;
    }
