...
/**
 * App using soap and rest microservices integration App exception. Extends an {@link MVCException MVC Exception}.
 */
public class GenericAppKarException extends MVCException {
	private static final long serialVersionUID = 1154130703565675579L;
	
	/**
	 * Creates a new App using soap and rest microservices integration Exception with the given arguments.
	 *
	...
	/**
	 * Creates a new App using soap and rest microservices integration Exception (500 - Internal Error) with a given
	 * context and message.
	 *
	 * @param ctx     Context
