...
// @formatter:off
/**
 * App using soap and rest microservices integration App implementation of an {@link AbstractMVCContext MVC Context}.
 * 
 */
@Component(
...
public class GenericAppKarContext extends AbstractMVCContext {
	...
	/**
	 * Creates a new App using soap and rest microservices integration Exception (500 - Internal Server Error) with the
	 * given error message.
	 *
