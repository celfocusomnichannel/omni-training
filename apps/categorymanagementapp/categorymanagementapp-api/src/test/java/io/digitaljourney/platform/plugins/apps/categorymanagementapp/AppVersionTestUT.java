...
public class AppVersionTestUT {
	...
	public void apiVersionTest() throws IOException, XmlPullParserException {
		...
		assertThat(majorVersion).isEqualTo(CategoryManagementAppProperties.CURRENT_VERSION);
	}
	...
	public void addressShouldEndWithVersionTest() {
		assertThat(CategoryManagementAppProperties.ADDRESS).endsWith("/v" + CategoryManagementAppProperties.CURRENT_VERSION);
	}
}
