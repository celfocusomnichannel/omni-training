...
/**
 * CategoryManagementApp properties	
 */
public final class CategoryManagementAppProperties extends RSProperties {
	
	private CategoryManagementAppProperties() {}

	public static final String APP_NAME = "categorymanagementapp";
	...
	public static final String CATEGORYMANAGEMENTAPP_TAG = APP_NAME;

	/** General Exception error code */
	public static final String CATEGORYMANAGEMENTAPP000 = "CATEGORYMANAGEMENTAPP000";
